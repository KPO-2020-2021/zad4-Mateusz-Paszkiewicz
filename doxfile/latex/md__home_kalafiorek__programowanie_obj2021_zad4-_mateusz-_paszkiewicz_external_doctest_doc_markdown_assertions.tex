...
Note that the {\ttfamily R\+E\+Q\+U\+I\+RE} level of asserts uses exceptions to end the current test case. It might be dangerous to use this level of asserts inside destructors of user-\/defined classes -\/ if a destructor is called during stack unwinding due to an exception and a {\ttfamily R\+E\+Q\+U\+I\+RE} assert fails then the program will terminate. Also since C++11 all destructors are by default {\ttfamily noexcept(true)} unless specified otherwise so such an assert will lead to {\ttfamily std\+::terminate()} being called.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md41}{}\doxysection{Expression decomposing asserts}\label{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md41}
...
For more information about the {\ttfamily I\+N\+F\+O()} macro and logging with the streaming {\ttfamily operator$<$$<$} visit the logging page.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md42}{}\doxysection{Binary and unary asserts}\label{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md42}
...
Using the \href{configuration.md\#doctest_config_super_fast_asserts}{\texttt{ $\ast$$\ast${\ttfamily D\+O\+C\+T\+E\+S\+T\+\_\+\+C\+O\+N\+F\+I\+G\+\_\+\+S\+U\+P\+E\+R\+\_\+\+F\+A\+S\+T\+\_\+\+A\+S\+S\+E\+R\+TS}$\ast$$\ast$}} config option can make the binary asserts to compile up to \href{benchmarks.md\#cost-of-an-assertion-macro}{\texttt{ {\bfseries{84-\/91\%}}}} faster!\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md43}{}\doxysection{Exceptions}\label{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md43}
...
Currently $\ast$$\ast$logging macros$\ast$$\ast$ cannot be used for extra context for asserts outside of a test run. That means that the {\ttfamily \+\_\+\+M\+E\+S\+S\+A\+GE} variants of asserts are also not usable -\/ since they are just a packed {\ttfamily I\+N\+F\+O()} with an assert right after it.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md45}{}\doxysection{Floating point comparisons}\label{md__home_kalafiorek__programowanie_obj2021_zad4-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md45}
